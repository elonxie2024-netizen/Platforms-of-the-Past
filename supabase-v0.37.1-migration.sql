-- v0.37.1: Time, Score, and Stars are shared views of each route's published runs.

update public.leaderboard_rulesets
set label = 'Custom Routes · Version 0.37.0 to 0.37.1',
    accepted_versions = array['v0.37.0', 'v0.37.1'],
    active = true
where id = 'full-custom-routes-v1';

update public.leaderboard_rulesets
set label = 'Classic Adventure · Version 0.24.1 to 0.37.1',
    accepted_versions = array_append(accepted_versions, 'v0.37.1'),
    active = true
where id = 'crate-jump-collision-v1'
  and not ('v0.37.1' = any(accepted_versions));
