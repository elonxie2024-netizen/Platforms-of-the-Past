...
const CHANGELOG_ENTRIES = [
  { version: "v0.13.1", commit: "Pending commit", date: "2026-08-16", message: "Fix run builder access", description: "Corrected the displayed version and script cache key so Play reliably loads and opens the custom run builder. Separated the v0.13.0 run-type release from the v0.12.0 rewind changelog and preserved both as playable versions." },
...
const RELEASE_VERSIONS = [
  "v0.13.1", "v0.13.0", "v0.12.0", "v0.11.7", "v0.11.6", "v0.11.5", "v0.11.4", "v0.11.3", "v0.11.2", "v0.11.1", "v0.11.0", "v0.10.4", "v0.10.3", "v0.10.2", "v0.10.1", "v0.10.0", "v0.9.2", "v0.9.1", "v0.9.0", "v0.8.3", "v0.8.1", "v0.8.0", "v0.7.6", "v0.7.5", "v0.7.4", "v0.7.2", "v0.7.1", "v0.7.0",
