...
const GAME_VERSION = "v0.21.4";
const SUPABASE_URL = "https://fuhqixfcdeyyjzpdnivy.supabase.co";
const SUPABASE_PUBLISHABLE_KEY = "sb_publishable_2ILI9grJw5pwi35d7v5qCQ_zTgh-I4A";
const LEADERBOARD_RULESETS = [
  { id: "zero-delay-platform-v1", label: "Version 0.21.4 to 0.21.4" },
...
const RELEASE_VERSIONS = [
  "v0.21.4", "v0.21.3", "v0.21.2", "v0.21.1", "v0.21.0", "v0.20.1", "v0.20.0", "v0.19.7", "v0.19.6", "v0.19.5", "v0.19.4", "v0.19.3", "v0.19.2", "v0.19.1", "v0.19.0", "v0.18.0", "v0.17.0", "v0.16.1", "v0.16.0", "v0.15.3", "v0.15.2", "v0.15.1", "v0.15.0",
