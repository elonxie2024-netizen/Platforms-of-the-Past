...
const LEADERBOARD_RULESETS = [
  { id: "crate-jump-collision-v1", label: "Version 0.24.1 to 0.30.2" },
...
const RELEASE_VERSIONS = [
  "v0.30.2", "v0.30.1", "v0.30.0", "v0.29.1", "v0.29.0", "v0.28.2", "v0.28.1", "v0.28.0", "v0.27.1", "v0.27.0",
