...
const CHANGELOG_ENTRIES = [
  { version: "v0.21.3", commit: "Pending commit", date: "2026-08-20", message: "Move the Cargo Countermove gate star", description: "Moved level 34's first star out of the raised cargo gate and onto the platform immediately beyond it, keeping the collectible clearly visible and safely reachable after opening the gate." },
...
const RELEASE_VERSIONS = [
  "v0.21.3", "v0.21.2", "v0.21.1", "v0.21.0", "v0.20.1", "v0.20.0", "v0.19.7", "v0.19.6", "v0.19.5", "v0.19.4", "v0.19.3", "v0.19.2", "v0.19.1", "v0.19.0", "v0.18.0", "v0.17.0", "v0.16.1", "v0.16.0", "v0.15.3", "v0.15.2", "v0.15.1", "v0.15.0",
